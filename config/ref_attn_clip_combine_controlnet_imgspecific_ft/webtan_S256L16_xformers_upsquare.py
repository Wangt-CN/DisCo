...
from config import *
from config.ref_attn_clip_combine_controlnet_imgspecific_ft.net import Net, inner_collect_fn
...
class Args(BasicArgs):
    ...
    # data
    dataset_cf = 'dataset/tiktok_controlnet_t2i_imagevar_combine_specifcimg_web_upsquare.py'
    ...
    web_data_root = './blob_dir/debug_output/video_sythesis/dataset/Lindsey_0504_youtube/frames_tan'
    # web_data_root = '/datadrive_d/wangtan/azure_storage/vigstandard_data/linjli/debug_output/video_sythesis/dataset/Lindsey_0504_youtube/frames_tan'
