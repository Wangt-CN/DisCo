...
from config import *
from config.ref_attn_clip_combine_controlnet_imgspecific_ft.net_lora import Net, inner_collect_fn
...
class Args(BasicArgs):
    ...
    web_data_root = './blob_dir/debug_output/video_sythesis/dataset/Lindsey_0504_youtube/frames/single_person'
